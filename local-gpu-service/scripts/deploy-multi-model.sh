...
echo "[4/5] 下载模型：$MODEL..."
# 预下载模型
python3 -c "from rembg import new_session; new_session('$MODEL')" 2>/dev/null || true
...
echo ""
echo "切换模型:"
echo "  ./deploy.sh <model-name> <port>"
echo "  例：./deploy.sh u2net 7000"
echo ""
echo "按 Ctrl+C 停止服务"
echo ""
